...
public class NewEnchantingScreen extends HandledScreen<NewEnchantingScreenHandler> {
    ...
    private static final Identifier EMPTY_HELMET = Identifier.of("minecraft", "textures/item/empty_armor_slot_helmet.png");
    private static final Identifier EMPTY_CHEST  = Identifier.of("minecraft", "textures/item/empty_armor_slot_chestplate.png");
    private static final Identifier EMPTY_LEGS   = Identifier.of("minecraft", "textures/item/empty_armor_slot_leggings.png");
    private static final Identifier EMPTY_BOOTS  = Identifier.of("minecraft", "textures/item/empty_armor_slot_boots.png");
    private static final Identifier EMPTY_SHIELD = Identifier.of("minecraft", "textures/item/empty_armor_slot_shield.png");
    ...
    protected void init() {
        ...
        if (this.client != null && this.client.world != null) {
            ...
            orderedEnchantments = Arrays.stream(ORDERED_ENCHANTMENTS)
                    .map(key -> (RegistryEntry<Enchantment>) registry.getEntry(key).orElseThrow())
                    .toList();
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(TEXTURE, x, y, 0, 0, 220, 222, 2750, 282);
